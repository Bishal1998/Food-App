...
const Signup = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-screen">
            <form onSubmit={singupHandler} className="md:p-8 w-full max-w-md md:border border-gray-200 rounded-lg">
                <div className={"mb-4"}>
                ...
                <div className={"mb-4"}>
                    <div className={"relative"}>
                        <Input type="text" placeholder="Enter your full name"
                               className={"pl-10 focus-visible:ring-1"} name={"fullName"} value={input.fullName}
                ...
                <div className={"mb-4"}>
                    <div className={"relative"}>
                        <Input type="text" placeholder="Enter your contact number"
                               className={"pl-10 focus-visible:ring-1"} name={"contact"} value={input.contact}
                               onChange={changeEventHandler}/>
