...
const Profile = () => {
  ...
  return (
    <form onSubmit={updateProfile} className="max-w-7xl mx-auto my-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Avatar className="relative md:w-28 md:h-28 w-20 h-20">
            <AvatarImage src={select} />
          ...
          <Input
            ...
            className="text-2xl font-bold outline-none border-none focus-visible:ring-transparent"
          />
        </div>
      </div>
