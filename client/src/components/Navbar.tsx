                ...
                <div className="hidden md:flex items-center gap-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/cart" className="relative cursor-pointer">
                            <ShoppingCart/>
                            <Button size='icon'
                                    className="absolute -inset-y-3 left-2 text-xs rounded-full w-4 h-4 bg-red-500 hover:bg-red-600">5</Button>
                        </Link>
                        <div>
                            <Avatar>
                                <AvatarImage/>
                        ...
                        <div>
                            {
                                loading ? (
                                    ...
                                    <Button className="bg-orange hover:bg-hoverOrange">Log out</Button>
                                )
                            }
...
const MobileNav = () => {
    return (
        <Sheet>
            <SheetTrigger>
                <Button size="icon" className="rounded-full bg-gray-200 text-black" variant="outline">
                    <Menu size={18}/>
                </Button>
            </SheetTrigger>
                ...
                <SheetFooter className="flex flex-col gap-4">
                    <>
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <h1 className="font-bold">Have Food</h1>
                        </div>
                    </>
